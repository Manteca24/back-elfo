...
const savedPersonSchema = new mongoose.Schema({
  ...
  relation: {type: String, enum: ["madre", "padre", "hermana", "hermano", "hija", "hijo", "abuela", "abuelo", "tía", "tío", "prima", "primo", "amiga", "amigo", "sobrina", "sobrino", "pareja", "novia", "novio", "esposo", "esposa", "cuñada", "cuñado", "compañero de trabajo", "compañera de trabajo", "jefe", "jefa", "vecino", "profesor", "alumno", "alumna", "profesora", "vecina", "cliente", "mascota"], required: true },
  filters: [
    {
